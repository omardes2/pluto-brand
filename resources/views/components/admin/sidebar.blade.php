...
>
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-1 admin-scroll">
        ...
        @can('pos.view')
            ...
            <a href="{{ route('admin.pos.screen') }}"
               @class([
                   'group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition',
                   'bg-emerald-500/15 text-white' => $posActive,
                   'text-slate-300 hover:bg-white/5 hover:text-white' => !$posActive,
               ])
               title="نقطة البيع">
                <svg class="w-5 h-5 shrink-0 {{ $posActive ? 'text-emerald-400' : '' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"/></svg>
                <span class="whitespace-nowrap" x-show="!collapsed" x-transition.opacity>نقطة البيع</span>
            </a>
        @endcan
