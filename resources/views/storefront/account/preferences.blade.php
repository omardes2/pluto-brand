<x-storefront.account-layout :title="__('account.preferences')" active="preferences">
    ...
    <form method="POST" action="{{ route('account.preferences.update') }}" class="bg-white rounded-xl border border-gray-200 p-5 space-y-5 max-w-xl">
        ...
        <div>
            ...
            <select id="preferred_locale" name="preferred_locale" class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900">
        ...
        <div>
            ...
            <select id="preferred_branch_id" name="preferred_branch_id" class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900">
                <option value="">{{ __('account.none') }}</option>
        ...
        <button type="submit" class="rounded-lg bg-gray-900 hover:bg-black text-white text-sm font-medium px-5 py-2.5">{{ __('account.save') }}</button>
    </form>
